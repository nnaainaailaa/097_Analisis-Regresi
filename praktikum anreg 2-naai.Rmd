...
data <- read_excel("C://Users//Na'aila//Documents//ANREG//NSC-2025.xlsx", sheet="Sheet2")
...
```{r}
plot(data$X7, data$Y,
     main = "Indeks Pembangunan Gender vs Indeks Pembangunan Manusia",
     xlab = "IPG",
     ylab = "IPM")
```
...
Nilai p lebih dari alpha 0.05 untuk b0, sehingga b0 tidak signifikan pada taraf nyata 5%
NIlai p kurang dari alpha 0.05 untuk b1, sehungga b1 signifikan pada taraf nyata 5%
...
$$\hat{Y} = -10.70937 + 0.9370334  X_7$$

dengan Y adalah Indeks Pembangunan Manusia dan X7 adalah indeks Pembangunan Gender.

Didapatkan nilai $\hat\beta_0 = -10.70937$ artinya nilai dugaan rataan indeks pembangunan manusia ketika indeks pembangunan gender bernilai 0 adalah -10.709, akan tetapi nilai 0 tidak ada dalam selang pengamatan indeks pembangunan gender sehingga $\hat\beta_0$ tidak dapat didefinisikan lebih lanjut

Nilai $\hat\beta_1 = 0.9370334$ artinya setiap kenaikan 1 unit pada Indeks Pembangunan Gender, dugaan rataan Indeks Pembangunan Manusia akan meningkat sebesar 0.937 unit, dengan asumsi variabel lain tetap.

Koefisien determinasi yang dihasilkan adalah 0.5108 atau 51.08% artinya keragaman indeks pembangunan manusia yang dapat dijelaskan oleh indeks pembangunan gender adalah sebesar 51.08%, sisanya yaitu 48.92% dijelaskan oleh peubah lain yang tidak dimasukkan dalam model.
